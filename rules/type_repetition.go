...
type TypeRepetitionRule struct {
	tflint.DefaultRule
}
...
// NewTypeRepetitionRule creates a new rule.
func NewTypeRepetitionRule() *TypeRepetitionRule {
	return &TypeRepetitionRule{}
}

// Name returns the rule name.
func (r *TypeRepetitionRule) Name() string {
	return "type_repetition"
}

// Enabled returns whether the rule is enabled by default.
func (r *TypeRepetitionRule) Enabled() bool {
	return true
}

// Severity returns the rule severity.
func (r *TypeRepetitionRule) Severity() tflint.Severity {
	return tflint.WARNING
}

// Link returns the rule reference link.
func (r *TypeRepetitionRule) Link() string {
	return project.ReferenceLink(r.Name())
}

// Message returns the rule message based on its type
func (r *TypeRepetitionRule) Message(blockType string) string {
	switch blockType {
	...
	default:
		panic(fmt.Sprintf("type_repetition: unexpected block type %q", blockType))
	}
}

// Check checks whether the rule is satisfied.
func (r *TypeRepetitionRule) Check(runner tflint.Runner) error {
