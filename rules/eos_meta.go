...
// eosMetaRuleConfig represents the configuration for the EosMetaRule.
...
// EosMetaRule checks for meta-argument style violations.
type EosMetaRule struct {
	tflint.DefaultRule
}

// NewEosMetaRule returns a new rule.
func NewEosMetaRule() *EosMetaRule {
	return &EosMetaRule{}
}

// Name returns the rule name.
func (r *EosMetaRule) Name() string {
	return "eos_meta"
}

// Enabled returns whether the rule is enabled by default.
func (r *EosMetaRule) Enabled() bool {
	return true
}

// Severity returns the rule severity.
func (r *EosMetaRule) Severity() tflint.Severity {
	return tflint.WARNING
}

// Link returns the rule reference link.
func (r *EosMetaRule) Link() string {
	return project.ReferenceLink(r.Name())
}

// Check checks whether the rule conditions are met.
func (r *EosMetaRule) Check(runner tflint.Runner) error {
...
func (r *EosMetaRule) emitIssue(runner tflint.Runner, message string, rng hcl.Range) {
