...
func TestEosMetaRule(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			`),
			Expected: helper.Issues{
				{Rule: NewEosMetaRule(), Message: eosOnlyDynamicGuardMessage},
				{Rule: NewEosMetaRule(), Message: eosGuardMustReturn10Message},
				{Rule: NewEosMetaRule(), Message: eosGuardMustReturn10Message},
				{Rule: NewEosMetaRule(), Message: eosOnlyDynamicGuardMessage},
				{Rule: NewEosMetaRule(), Message: eosOnlyDynamicGuardMessage},
			},
		},
		{
			...
			`),
			Expected: helper.Issues{
				{Rule: NewEosMetaRule(), Message: eosMisOrderedMessage},
				{Rule: NewEosMetaRule(), Message: eosMisOrderedMessage},
				{Rule: NewEosMetaRule(), Message: eosMisOrderedMessage},
			},
		},
		{
			...
			Expected: helper.Issues{
				...
				{Rule: NewEosMetaRule(), Message: "Git module source should specify ref parameter."},
				{Rule: NewEosMetaRule(), Message: "Mercurial module source should specify #revision."},
				{Rule: NewEosMetaRule(), Message: "https module source should specify a valid archive extension."},
				{Rule: NewEosMetaRule(), Message: "https module source should specify a valid archive extension."},
				{Rule: NewEosMetaRule(), Message: "Module from registry should specify version."},
				{Rule: NewEosMetaRule(), Message: "Module from registry should specify version."},
				{Rule: NewEosMetaRule(), Message: "Version constraint > or >= should not be used. Use ~> or exact version."},
				{Rule: NewEosMetaRule(), Message: "Version constraint > or >= should not be used. Use ~> or exact version."},
				{Rule: NewEosMetaRule(), Message: "Version constraint > or >= should not be used. Use ~> or exact version."},
				{Rule: NewEosMetaRule(), Message: "Pessimistic version constraint should specify at least major and minor version."},
			},
		},
	}
