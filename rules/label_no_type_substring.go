...
type LabelNoTypeSubstringRule struct {
	BaseRule
}

func NewLabelNoTypeSubstringRule() *LabelNoTypeSubstringRule {
	return &LabelNoTypeSubstringRule{
		BaseRule: BaseRule{ruleName: "label_no_type_substring"},
	}
}

func (r *LabelNoTypeSubstringRule) Link() string {
	return project.ReferenceLink(r.Name())
}

func (r *LabelNoTypeSubstringRule) Check(runner tflint.Runner) error {
