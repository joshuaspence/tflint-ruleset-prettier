...
type LabelSnakeRule struct {
	BaseRule
}

func NewLabelSnakeRule() *LabelSnakeRule {
	return &LabelSnakeRule{
		BaseRule: BaseRule{ruleName: "label_snake"},
	}
}

func (r *LabelSnakeRule) Link() string {
	return project.ReferenceLink(r.Name())
}

func (r *LabelSnakeRule) Check(runner tflint.Runner) error {
