...
type VariableAlphabeticalOrderRule struct {
	BaseRule
}

func NewVariableAlphabeticalOrderRule() *VariableAlphabeticalOrderRule {
	return &VariableAlphabeticalOrderRule{
		BaseRule: BaseRule{ruleName: "variable_alphabetical_order"},
	}
}

func (r *VariableAlphabeticalOrderRule) Link() string {
	return project.ReferenceLink(r.Name())
}

func (r *VariableAlphabeticalOrderRule) Check(runner tflint.Runner) error {
