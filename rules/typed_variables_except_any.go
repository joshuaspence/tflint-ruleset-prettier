...
// TypeVariablesExceptAnyRule warns when a variable is declared with type any or contains any.
type TypeVariablesExceptAnyRule struct {
	tflint.DefaultRule
}

// NewTypeVariablesExceptAnyRule creates a new rule.
func NewTypeVariablesExceptAnyRule() *TypeVariablesExceptAnyRule {
	return &TypeVariablesExceptAnyRule{}
}

// Name returns the rule name.
func (r *TypeVariablesExceptAnyRule) Name() string {
	return "typed_variables_except_any"
}

// Enabled returns whether the rule is enabled by default.
func (r *TypeVariablesExceptAnyRule) Enabled() bool {
	return true
}

// Severity returns the rule severity.
func (r *TypeVariablesExceptAnyRule) Severity() tflint.Severity {
	return tflint.WARNING
}

// Link returns the rule reference link.
func (r *TypeVariablesExceptAnyRule) Link() string {
	return project.ReferenceLink(r.Name())
}

// Message returns the rule message.
func (r *TypeVariablesExceptAnyRule) Message() string {
	return "Using 'any' as variable type should be avoided"
}

func (r *TypeVariablesExceptAnyRule) Check(runner tflint.Runner) error {
