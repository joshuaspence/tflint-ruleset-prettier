...
// eosCommentsRuleConfig represents the configuration for the EosCommentsRule.
...
// EosCommentsRule checks for comment style.
type EosCommentsRule struct {
	tflint.DefaultRule
}

// NewEosCommentsRule returns a new rule.
func NewEosCommentsRule() *EosCommentsRule {
	return &EosCommentsRule{}
}

// Name returns the rule name.
func (r *EosCommentsRule) Name() string {
	return "eos_comments"
}

// Enabled returns whether the rule is enabled by default.
func (r *EosCommentsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity.
func (r *EosCommentsRule) Severity() tflint.Severity {
	return tflint.WARNING
}

// Link returns the rule reference link.
func (r *EosCommentsRule) Link() string {
	return project.ReferenceLink(r.Name())
}

// Check checks whether the rule conditions are met.
func (r *EosCommentsRule) Check(runner tflint.Runner) error {
...
func eosCheckCommentsWithContext(
	...
	rule *EosCommentsRule,
	config *eosCommentsRuleConfig,
	checkFuncs ...func(*EosCommentsRule, *eosCommentsRuleConfig, string, tflint.Runner, hclsyntax.Token, *hclsyntax.Token),
) error {
