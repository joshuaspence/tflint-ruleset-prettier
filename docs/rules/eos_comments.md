...
Warning: Avoid jammed comment ('#This ...'). (eos_comments)

  on main.tf line 1:
   1: #This is a jammed comment

Warning: Avoid jammed comment ('//Thi ...'). (eos_comments)

  on main.tf line 2:
   2: //This is also jammed

Warning: Wrap comment at column 80 (currently 126). (eos_comments)
...
Warning: Avoid EOL comments. (eos_comments)

  on main.tf line 7:
   7:   ami = var.ami # EOL comment

Reference: https://github.com/joshuaspence/tflint-ruleset-prettier/blob/v0.2.0/docs/rules/eos_comments.md
```
