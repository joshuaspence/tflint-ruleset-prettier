...
Warning: Using 'any' as variable type should be avoided (typed_variables_except_any)

  on test.tf line 2:
   2:   type        = any

Reference: https://github.com/joshuaspence/tflint-ruleset-prettier/blob/v0.2.0/docs/rules/typed_variables_except_any.md
