...
Warning: Resource name should not repeat its resource type (type_repetition)

  on test.tf line 1:
   1: resource "aws_iam_role" "lambda_role" {

Reference: https://github.com/joshuaspence/tflint-ruleset-prettier/blob/v0.2.0/docs/rules/type_repetition.md

Warning: Data source name should not repeat its data source type (type_repetition)
