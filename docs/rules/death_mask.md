...
Warning: Avoid commented-out code. (death_mask)
...
Reference: https://github.com/joshuaspence/tflint-ruleset-prettier/blob/v0.2.0/docs/rules/death_mask.md
```
