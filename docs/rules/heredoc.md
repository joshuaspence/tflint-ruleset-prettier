...
Warning: Use indented heredoc (<<-) instead of standard heredoc (<<). (heredoc)

  on main.tf line 10:
   10:   input = <<EOF

Warning: 'EOF' is used as a heredoc delimiter. (heredoc)

  on main.tf line 10:
   10:   user_data = <<EOF

Reference: https://github.com/joshuaspence/tflint-ruleset-prettier/blob/v0.2.0/docs/rules/heredoc.md
```
